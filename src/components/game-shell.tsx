...
export default function GameShell({
  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden relative" style={{ background: "var(--ttg-black)" }}>
      ...
      <div className="flex-shrink-0 bg-[#111] border-b border-ttg-yellow/20 px-3 py-2 flex items-center gap-3 z-50">
        {showBack && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-ttg-yellow hover:text-white bg-white/5 hover:bg-white/10 border border-ttg-yellow/30 hover:border-ttg-yellow/60 transition-all"
          >
        ...
        <Disc3 className="w-5 h-5 text-ttg-yellow" />
        {title && (
