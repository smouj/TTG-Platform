    ...
    <div className="sticky bottom-0 z-40 bg-[#FFCC00] border-t-[3px] border-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-4 py-1.5 flex items-center justify-between text-[9px] sm:text-[10px] font-black uppercase tracking-wider text-[#1a1a1a]">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <span className="text-[#1a1a1a]/25 text-[7px] sm:text-[8px] tracking-[0.15em]">v0.4.0</span>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen flex flex-col mag-bg">
      ...
      <header className="sticky top-0 z-40 border-b-[3px] border-[#1a1a1a]" style={{
        ...
        {/* Tab Bar — fully rectangular, magazine-style */}
            ...
            {NAV_ITEMS.map(({ id, label, icon: Icon, href }) => {
              ...
              return (
                <Link key={id} href={href}
                  className={`relative flex items-center gap-1 px-2.5 sm:px-3.5 py-1.5 sm:py-2 font-black text-[9px] sm:text-[10px] tracking-wider uppercase transition-all whitespace-nowrap border-[3px] border-b-0 ${
                    isActive
                      ? "bg-[#FFCC00] text-[#1a1a1a] border-[#1a1a1a] -mb-[1px] z-10"
                      : "bg-white/60 text-[#1a1a1a]/45 border-[#1a1a1a]/10 hover:bg-white/90 hover:text-[#1a1a1a]/70 hover:border-[#1a1a1a]/20"
                  }`}
                  style={isActive ? {
        ...
        <footer className="bg-[#1a1a1a] border-t-[3px] border-[#FFCC00]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 py-2.5 gap-2">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <Link href="/faq" className="text-[9px] font-bold text-white/30 hover:text-[#FFCC00] uppercase tracking-wider transition-colors">FAQ</Link>
              <Link href="/privacy" className="text-[9px] font-bold text-white/30 hover:text-[#FFCC00] uppercase tracking-wider transition-colors">Privacy</Link>
            ...
            <span className="text-[8px] font-black text-white/15 uppercase tracking-[0.3em] whitespace-nowrap">
              &copy; 2026 Trading Tazos Game &middot; v0.4.0
            </span>
          </div>
        </footer>
      )}
