    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white">{t.auth_register}</h1>
          <p className="mt-2 text-zinc-400">{t.auth_register_subtitle}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-zinc-900/50 border border-zinc-800 rounded-xl p-8">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p className="mt-1 text-xs text-zinc-500">{t.auth_password_min}</p>
          </div>
          ...
          >
            {submitting ? t.common_loading : t.auth_register}
          </button>
