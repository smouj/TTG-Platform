...
export default function BagShopPage() {
  ...
  const startTearAnimation = () => {
    setOpeningAnim(true)
    const duration = 2000 // 2 seconds tear
    const interval = 50
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="mag-btn text-xs font-black uppercase px-3 py-1.5 border-2 border-[#1a1a1a] bg-white shadow-[2px_2px_0px_#1a1a1a] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all">
            <ArrowLeft className="w-3 h-3 inline mr-1" /> {t.common_back || "Back"}
          </Link>
        ...
        {error && (
          <div className="p-3 bg-red-50 border-2 border-red-300 rounded text-center">
            ...
            <button onClick={() => setError(null)} className="text-[10px] underline mt-1">
          ...
          {BAGS.map(bag => (
            ...
            >
              ...
              <div className="space-y-1 text-[10px] font-bold text-zinc-500">
                <p>🎯 {bag.rareBoost}x rare boost</p>
                <p>🎁 {bag.bonusChance}% bonus tazo</p>
  ...
  if (stage === "reveal" && revealedTazo) {
    ...
    return (
      <div className="max-w-2xl mx-auto py-8 px-4 space-y-6 text-center">
        ...
        {/* Bonus tazo */}
        {bonusTazo && (
          <div className="p-4 bg-[#F59E0B10] border-2 border-[#F59E0B] rounded-lg">
