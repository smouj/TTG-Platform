    ...
    <AdminShell accentColor="var(--ttg-purple)">
      ...
      <div className="border-3 border-ttg-black shadow-[4px_4px_0px_var(--ttg-black)] bg-white p-5">
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <label className={`mag-btn px-5 py-2.5 text-[10px] font-black uppercase text-white border-3 border-ttg-black shadow-[3px_3px_0px_var(--ttg-black)] cursor-pointer transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_var(--ttg-black)] ${uploading ? "bg-ttg-black/40" : "bg-ttg-dracobell"}`}>
      ...
      {Object.entries(grouped).map(([franchiseKey, items]) => (
        <div key={franchiseKey} className="border-3 border-ttg-black shadow-[4px_4px_0px_var(--ttg-black)] bg-white">
          <div className="px-5 py-3 border-b-2 border-ttg-black bg-ttg-black/0.02 flex items-center gap-2">
            <ImageIcon aria-hidden="true" className="w-4 h-4 text-ttg-dracobell" />
